...
function SearchForm () {
  ...
  return (
    ...
    <div className="search-form__container">
      ...
      <input className="search-form__input-field" type="text" placeholder="Фильм"></input>
      <button className="search-form__search-btn link" type="button">Найти</button>
    </div>
    <div className="search-form__delimeter"></div>
    <div className="search-form__switcher-container">
      <button className={`search-form__switcher ${activeSwitcher ? "active" : ""}`} onClick={handleSwitcherClick}>
